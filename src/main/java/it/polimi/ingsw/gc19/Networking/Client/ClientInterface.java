...
public interface ClientInterface {
    /**
     * The method is used to connect a client to the server.
    ...
    /**
     * To set the personal token.
     * @param token a hash representing the personal secret token.
     */
    void setToken(String token);

    /**
     * To set the personal nickname.
     * @param nickname a string representing the public nickname of the player.
     */
