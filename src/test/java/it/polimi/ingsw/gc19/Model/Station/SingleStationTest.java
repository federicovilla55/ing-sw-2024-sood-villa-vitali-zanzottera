...
class SingleStationTest {
    ...
    public SingleStationTest() throws IOException {
        ...
        game = new Game(1, "game");
        Player player = new Player("player", null, null, null);
        this.station = new Station(player, null, null, null);
        this.station.setMessageFactory(messageFactory);
