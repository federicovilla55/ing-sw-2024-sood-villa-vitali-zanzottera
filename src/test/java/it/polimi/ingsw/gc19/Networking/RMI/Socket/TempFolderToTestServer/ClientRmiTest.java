...
public class ClientRmiTest extends UnicastRemoteObject implements VirtualClient {
    final VirtualMainServer server;
    protected ClientRmiTest(VirtualMainServer server) throws RemoteException {
        this.server = server;
    }
    ...
    public static void main(String[] args)  throws RemoteException, NotBoundException {
        ...
        VirtualMainServer server = (VirtualMainServer) registry.lookup("RMIServer");
